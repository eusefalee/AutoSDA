...
node	9101	[expr 9*$BayWidth]	[expr 0*$FirstStory]; 	# Level 1
node	9102	[expr 9*$BayWidth]	[expr 1*$FirstStory]; 	# Level 2
node	9103	[expr 9*$BayWidth]	[expr 1*$FirstStory+1*$TypicalStory];	# Level 3
node	9104	[expr 9*$BayWidth]	[expr 1*$FirstStory+2*$TypicalStory];	# Level 4
node	9105	[expr 9*$BayWidth]	[expr 1*$FirstStory+3*$TypicalStory];	# Level 5

# puts "Nodes for leaning column defined" 

# Define extra nodes needed to define leaning column springs 
node	91022	[expr 9*$BayWidth]	[expr 1*$FirstStory+0*$TypicalStory];	# Node below floor level 2
node	91024	[expr 9*$BayWidth]	[expr 1*$FirstStory+0*$TypicalStory];	# Node above floor level 2
node	91032	[expr 9*$BayWidth]	[expr 1*$FirstStory+1*$TypicalStory];	# Node below floor level 3
node	91034	[expr 9*$BayWidth]	[expr 1*$FirstStory+1*$TypicalStory];	# Node above floor level 3
node	91042	[expr 9*$BayWidth]	[expr 1*$FirstStory+2*$TypicalStory];	# Node below floor level 4
node	91044	[expr 9*$BayWidth]	[expr 1*$FirstStory+2*$TypicalStory];	# Node above floor level 4
node	91052	[expr 9*$BayWidth]	[expr 1*$FirstStory+3*$TypicalStory];	# Node below floor level 5
