...
set	LateralLoad	[list	42.599329	97.977755	162.359135	233.551386];
...
load	9102	0	[expr -1*$LeaningColumnDeadLoadFloor2]	0; 
load	9103	0	[expr -1*$LeaningColumnDeadLoadFloor3]	0; 
load	9104	0	[expr -1*$LeaningColumnDeadLoadFloor4]	0; 
load	9105	0	[expr -1*$LeaningColumnDeadLoadFloor5]	0; 
