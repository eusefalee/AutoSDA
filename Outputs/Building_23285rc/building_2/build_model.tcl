...
node	28	[expr 1*$Lw]	[expr 1*$FirstStory+6*$TypicalStory]; # Level 8
node	29	[expr 1*$Lw]	[expr 1*$FirstStory+7*$TypicalStory]; # Level 9
...
# Story 7
element	elasticBeamColumn	32728	27	28	$AreaRigid	$Ec	$PDcolI	$PDeltaTransf;

# Story 8
element	elasticBeamColumn	32829	28	29	$AreaRigid	$Ec	$PDcolI	$PDeltaTransf;
...
equalDOF	114	28	$ConstrainDOF;	# wall to Leaning column - level 8 
equalDOF	116	29	$ConstrainDOF;	# wall to Leaning column - level 9 
...
set fc_sbe 9.823; 	# peak compressive stress
...
set fc_obe 9.475; 	# peak compressive stress
...
set rouXw 0.013;		# Reinforcing in X (horizontal) direction, web
...
set rouYb 0.070;		# Reinforcing in Y (vertical) direction, boundary
...
# Node recorders
# Displacements
recorder Node -file $dataDirName/NodeDisp.out -time -nodeRange 100 116 -dof 1 2 disp;
...
recorder Drift -file $dataDirName/DriftRoof.out -time -iNode 100 -jNode 116 -dof 1 -perpDirn 2; # Roof 
recorder Drift -file $dataDirName/DriftStory.out -time -iNode 100 102 104 106 108 110 112 114 -jNode 102 104 106 108 110 112 114 116 -dof 1 -perpDirn 2; # Story 


# Record responses for wall elements 
recorder Element -file $dataDirName/WallGlobalForces.out -time -ele 1001 1002 1003 1004 1005 1006 1007 1008 1009 1010 1011 1012 1013 1014 1015 1016 globalForce; 
recorder Element -file $dataDirName/WallCurvature.out -time -ele 1001 1002 1003 1004 1005 1006 1007 1008 1009 1010 1011 1012 1013 1014 1015 1016 Curvature; 
recorder Element -file $dataDirName/WallShearDef.out -time -ele 1001 1002 1003 1004 1005 1006 1007 1008 1009 1010 1011 1012 1013 1014 1015 1016 ShearDef; 

# Record responses for wall fibers (one panel per recorder)
# Command: RCPanel $fibTag $Response 
recorder Element -file $dataDirName/WallFiberStrain_f1.out -time -ele 1001 1002 1003 1004 1005 1006 1007 1008 1009 1010 1011 1012 1013 1014 1015 1016 RCPanel 1 panel_strain 
recorder Element -file $dataDirName/WallFiberStrain_f6.out -time -ele 1001 1002 1003 1004 1005 1006 1007 1008 1009 1010 1011 1012 1013 1014 1015 1016 RCPanel 6 panel_strain 
...
set	WallDeadLoadFloor	181.984;
# Assign point live load values on wall: (kip)
set	WallLiveLoadFloor	13.865;
# Assign point dead load values on leaning column: (kip)
set	LeaningColumnDeadLoadFloor	556.298;
# Assign point live load values on leaning column: (kip)
set	LeaningColumnLiveLoadFloor	42.385;
