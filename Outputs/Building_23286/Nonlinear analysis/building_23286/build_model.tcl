...
set LengthBoundEl 65.000;			# Boundary Length
set Twall 35.000;    # Wall thickness
...
set fc_sbe 9.200; 	# peak compressive stress
set ec0_sbe -0.004;# strain at peak compressive stress
...
set fc_obe 8.987; 	# peak compressive stress
...
set rouXb_sbe 0.008;		# Reinforcing in X (horizontal) direction, boundary
set rouXb_obe 0.006;		# Reinforcing in X (horizontal) direction, boundary
set rouYb 0.044;		# Reinforcing in Y (vertical) direction, boundary
...
set	WallDeadLoadFloor	185.787;
# Assign point live load values on wall: (kip)
set	WallLiveLoadFloor	14.155;
# Assign point dead load values on leaning column: (kip)
set	LeaningColumnDeadLoadFloor	552.494;
# Assign point live load values on leaning column: (kip)
set	LeaningColumnLiveLoadFloor	42.095;
