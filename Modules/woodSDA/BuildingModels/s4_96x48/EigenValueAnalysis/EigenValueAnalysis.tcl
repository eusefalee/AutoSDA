...
puts $mode_file "[nodeEigenvector 4000 1 1]	[nodeEigenvector 4000 2 1]	[nodeEigenvector 4000 3 1]	[nodeEigenvector 4000 4 1]	"
puts $mode_file "[nodeEigenvector 5000 1 1]	[nodeEigenvector 5000 2 1]	[nodeEigenvector 5000 3 1]	[nodeEigenvector 5000 4 1]	"
close $mode_file
