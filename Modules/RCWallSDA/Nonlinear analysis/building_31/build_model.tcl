...
set LengthBoundEl 41.000;			# Boundary Length
set Twall 24.000;    # Wall thickness
...
set fc_sbe 9.706; 	# peak compressive stress
...
set fc_obe 9.382; 	# peak compressive stress
...
set rouXw 0.012;		# Reinforcing in X (horizontal) direction, web
set rouYw 0.003;		# Reinforcing in Y (vertical) direction, web
set rouXb_sbe 0.012;		# Reinforcing in X (horizontal) direction, boundary
set rouXb_obe 0.009;		# Reinforcing in X (horizontal) direction, boundary
set rouYb 0.064;		# Reinforcing in Y (vertical) direction, boundary
...
set	WallDeadLoadFloor	182.569;
# Assign point live load values on wall: (kip)
set	WallLiveLoadFloor	13.910;
# Assign point dead load values on leaning column: (kip)
set	LeaningColumnDeadLoadFloor	555.712;
# Assign point live load values on leaning column: (kip)
set	LeaningColumnLiveLoadFloor	42.340;
