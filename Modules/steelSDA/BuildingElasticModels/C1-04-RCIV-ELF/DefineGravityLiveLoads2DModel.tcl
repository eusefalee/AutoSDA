...
eleLoad	-ele	29211021	-type	-beamUniform	[expr -1*$BeamLiveLoadFloor2]; 
...
eleLoad	-ele	29311031	-type	-beamUniform	[expr -1*$BeamLiveLoadFloor3]; 
...
eleLoad	-ele	29411041	-type	-beamUniform	[expr -1*$BeamLiveLoadFloor4]; 
...
eleLoad	-ele	29511051	-type	-beamUniform	[expr -1*$BeamLiveLoadFloor5]; 



# Define point loads on leaning column
load	9112	0	[expr -1*$LeaningColumnLiveLoadFloor2]	0; 
load	9113	0	[expr -1*$LeaningColumnLiveLoadFloor3]	0; 
load	9114	0	[expr -1*$LeaningColumnLiveLoadFloor4]	0; 
load	9115	0	[expr -1*$LeaningColumnLiveLoadFloor5]	0; 
