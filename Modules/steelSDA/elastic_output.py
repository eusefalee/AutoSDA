# This file is used to define the class of postprocessing the elastic analysis results
...
if DESIGN_METHOD == 'RSA':
    LOAD_TYPE = ['DeadLoad', 'LiveLoad', 'RSACombineEarthquakeLoad']
...
class ElasticOutput(object):
    """
    This class is used to do the following jobs:
