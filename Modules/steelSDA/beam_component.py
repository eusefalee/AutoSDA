...
from global_variables import ADOPT_RBS_CONNECTION
...
class Beam(object):
    ...
    def initialize_reduced_beam_section(self):
        ...
        if ADOPT_RBS_CONNECTION:
            ...
            self.RBS_dimension['a'] = 0
            self.RBS_dimension['b'] = 0
            self.RBS_dimension['c'] = 0
    ...
    def check_flange(self, steel):
        ...
        if ADOPT_RBS_CONNECTION:
            ...
            lambda_f = self.section['bf'] / (2*self.section['tf'])
